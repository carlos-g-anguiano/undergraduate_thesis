...
%= & \frac{2A}{\pi} \bigg[ e^{-2|\alpha - z|^2} + c^* \langle 2z-\beta \vert \alpha \rangle \left[ e^{\frac{1}{2}(z^*(z-\beta) - (z-\beta)^* z)} e^{\frac{1}{2}(z^*\alpha - z \alpha^*)} e^{\frac{1}{2}(z^*\beta - z \beta^*)}\right]^* \\ & + c \langle \alpha \vert 2z - \beta\rangle e^{\frac{1}{2}(z^*(z-\beta) - (z-\beta)^* z)} e^{\frac{1}{2}(z^*\alpha - z \alpha^*)} e^{\frac{1}{2}(z^*\beta - z \beta^*)} + |c|^2 e^{-2|\beta - z|^2} \bigg] \\
